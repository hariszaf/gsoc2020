...
```{r pressure, echo=FALSE, fig.cap="Plot from MATLAB", out.width = '75%'}
knitr::include_graphics("https://raw.githubusercontent.com/hariszaf/gsoc2020/master/test_hard_files/figure-html/matlab_plot.jpg")
```
